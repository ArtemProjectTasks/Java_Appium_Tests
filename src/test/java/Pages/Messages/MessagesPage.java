...
public class MessagesPage extends BasePage {
    private final By moreOptionsLocator = By.xpath("//android.widget.ImageView[@content-desc=\"More options\"]");
    private final By settingsLocator = By.xpath("//*[contains(@text, 'Settings')]//ancestor::android.widget.LinearLayout[@resource-id=\"com.google.android.apps.messaging:id/content\"]");
